...
//            drivetrain.run(new Vector(0,0), new Vector (-gamepad1.right_stick_x,0), input,  0);
            telemetry.addData("left ", hardware.motors.leftFront.dcMotorEx.getCurrentPosition());
            telemetry.addData("right ", hardware.motors.rightBack.dcMotorEx.getCurrentPosition());
            telemetry.addData("strafe ", hardware.motors.rightFront.dcMotorEx.getCurrentPosition());

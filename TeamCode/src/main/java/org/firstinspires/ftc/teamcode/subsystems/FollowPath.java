...
public class FollowPath extends Command {
    ...
    public FollowPath(PathChain path, boolean holdEnd, Double maxPower, Follower follower) {
        this.path = path;
    ...
    public FollowPath(Path path, boolean holdEnd, Double maxPower, Follower follower) {this(new PathChain(path), holdEnd, maxPower, follower);}
     ...
     * @param follower
     */
    public FollowPath(PathChain path, Follower follower) {this(path, false, 1.0, follower);}
     ...
     * @param follower
     */
    public FollowPath(Path path, Follower follower) {this(path, false, 1.0, follower);}

...
public class OuttakeClaw extends Subsystem {
    ...
    public Command outtakeToggle(){
        return new BlockingConditionalCommand(
                () -> servo.getPosition() == hardware.servoPositions.outtakeGrip.getPosition(),
                this::open,
                this::close
        );
    }
    ...
    public void periodic() {
        OpModeData.telemetry.addData("outtake closed", servo.getPosition() == hardware.servoPositions.outtakeGrip.getPosition());
    }
}

...
public class Turn extends Command {
    ...
    public Turn(PathChain path, boolean holdEnd, Double maxPower, Follower follower) {
        this.path = path;
    ...
    public Turn(Path path, boolean holdEnd, Double maxPower, Follower follower) {this(new PathChain(path), holdEnd, maxPower, follower);}
     ...
     * @param follower
     */
    public Turn(PathChain path, Follower follower) {this(path, false, 1.0, follower);}
     ...
     * @param follower
     */
    public Turn(Path path, Follower follower) {this(path, false, 1.0, follower);}
